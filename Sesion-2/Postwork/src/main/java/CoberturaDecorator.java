// La clase CoberturaDecorator implementa la interfaz Helado y actúa como un decorador para agregar funcionalidad adicional a un objeto de tipo Helado.
public class CoberturaDecorator implements Helado {
    ...
    // Constructor de la clase CoberturaDecorator que recibe un objeto de tipo Helado como argumento.
    public CoberturaDecorator(Helado helado) {
        this.helado = helado; // Se asigna el helado pasado como argumento al objeto helado de esta instancia de CoberturaDecorator.
    }

    // Implementación del método getDescription definido en la interfaz Helado.
    @Override
    public String getDescription() {
        // Se obtiene la descripción del helado original llamando al método getDescription en el objeto helado y se agrega ", con Cobertura extra".
